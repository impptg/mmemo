...
PY
swiftc apps/desktop/Store.swift apps/desktop/AI.swift apps/desktop/Cloud.swift apps/desktop/Updates.swift "$work/main.swift" -o "$work/check" -framework AppKit -framework WebKit
"$work/check"
