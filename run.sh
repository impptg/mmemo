...
MACOSX_DEPLOYMENT_TARGET=13.0 swiftc -O apps/desktop/Store.swift apps/desktop/AI.swift apps/desktop/Cloud.swift apps/desktop/main.swift -o "$app/Contents/MacOS/mmemo" -framework AppKit -framework WebKit
cp apps/desktop/web/* "$app/Contents/Resources/web/"
...
swift apps/desktop/icons.swift "$app/Contents/Resources/web/icons"
